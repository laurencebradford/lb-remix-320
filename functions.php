...
if( !function_exists( "wp_bootstrap_theme_js" ) ) {  
  function wp_bootstrap_theme_js(){
    ...
    wp_register_script( 'bootstrap', 
      get_template_directory_uri() . '/assets/bower_components/bootstrap-sass/assets/javascripts/bootstrap.min.js', 
      array('jquery'), 
      '1.2' );
    ...
    wp_register_script( 'modernizr', 
      get_template_directory_uri() . 'assets/bower_components/modernizer/modernizr.js', 
      array('jquery'), 
      '1.2' );
